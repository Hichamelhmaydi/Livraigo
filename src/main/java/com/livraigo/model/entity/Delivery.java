...
public class Delivery {
    ...
    public Delivery(String address, Double latitude, Double longitude, Double weight, Double volume,
            LocalTime preferredTimeStart, LocalTime preferredTimeEnd, DeliveryStatus status, Tour tour, Integer order) {
